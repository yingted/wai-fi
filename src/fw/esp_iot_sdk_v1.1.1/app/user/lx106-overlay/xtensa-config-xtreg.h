...
XTREG( 16, 64,32, 4, 4,0x0020,0x0006 & ~1,-2, 9,0x0100,pc,          0,0,0,0,0,1)
...
XTREG( 20, 80,32, 4, 4,0x02d0,0x0002 & ~1,-2, 2,0x1000,sr208,       0,0,0,0,1,0)
XTREG( 21, 84, 6, 4, 4,0x02e6,0x0006 & ~1,-2, 2,0x1100,ps,          0,0,0,0,0,0)
XTREG( 22, 88,32, 4, 4,0x0259,0x000d & ~1,-2, 2,0x1000,mmid,        0,0,0,0,1,0)
...
XTREG( 38,152,15, 4, 4,0x02e2,0x000d & ~1,-2, 2,0x1000,intset,      0,0,0,0,1,1)
XTREG( 39,156,15, 4, 4,0x02e3,0x000d & ~1,-2, 2,0x1000,intclear,    0,0,0,0,1,1)
...
XTREG( 43,172,12, 4, 4,0x02e9,0x0003 & ~1,-2, 2,0x1000,debugcause,  0,0,0,0,0,1)
XTREG( 44,176,32, 4, 4,0x02ea,0x000f & ~1,-2, 2,0x1000,ccount,      0,0,0,0,0,0)
XTREG( 45,180,32, 4, 4,0x02eb,0x0003 & ~1,-2, 2,0x1000,prid,        0,0,0,0,0,1)
...
#endif
#ifdef XTREG_masked
XTREG_masked( 50,200, 4, 4, 4,0x2002,0x0006,-2, 6,0x1010,psintlevel,
        0,0,&xtensa_mask0,0,0,0)
XTREG_masked( 51,204, 1, 4, 4,0x2003,0x0006,-2, 6,0x1010,psum,
        0,0,&xtensa_mask1,0,0,0)
XTREG_masked( 52,208, 1, 4, 4,0x2004,0x0006,-2, 6,0x1010,psexcm,
        0,0,&xtensa_mask2,0,0,0)
XTREG_masked( 53,212,20, 4, 4,0x2005,0x0006,-2, 6,0x1010,litbaddr,
        0,0,&xtensa_mask3,0,0,0)
XTREG_masked( 54,216, 1, 4, 4,0x2006,0x0006,-2, 6,0x1010,litben,
